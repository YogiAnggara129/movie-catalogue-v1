package com.anggasaraya.moviecatalogue.data.remote.response
...
data class DetailTVShowResponse(
	...
	val productionCountries: List<ProductionCountriesItemTVShow?>? = null,
...
data class ProductionCompaniesItemTVShow(
		...
		@field:SerializedName("logo_pat")
		val logoPat: String?= null,
